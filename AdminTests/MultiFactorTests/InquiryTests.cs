...
namespace JinCreek.Server.AdminTests.MultiFactorTests
{
    ...
    public class InquiryTests : IClassFixture<CustomWebApplicationFactory<JinCreek.Server.Admin.Startup>>
    {
        ...
        public InquiryTests(CustomWebApplicationFactory<JinCreek.Server.Admin.Startup> factory)
        {
            ...
            _context.Add(_user2 = new GeneralUser() { AccountName = "user2", DomainId = _domain1.Id });
        ...
        public void Case04()
        {
            ...
            _context.SaveChanges();
            var (response, _, json) = Utils.Get(_client, $"{Url}/{multiFactor.Id}", "user0", "user0");//    スーパー管理者
