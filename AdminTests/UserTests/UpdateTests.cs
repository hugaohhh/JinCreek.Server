...
namespace JinCreek.Server.AdminTests.UserTests
{
    ...
    public class UpdateTests : IClassFixture<CustomWebApplicationFactory<JinCreek.Server.Admin.Startup>>
    {
        ...
        public UpdateTests(CustomWebApplicationFactory<JinCreek.Server.Admin.Startup> factory)
        {
            ...
            _context.Add(_domain11 = new Domain { Id = Guid.NewGuid(), Name = "domain11", Organization = _org1 });
            ...
            _context.Add(new UserAdmin { AccountName = "user1", Password = Utils.HashPassword("user1"), Domain = _domain11 }); // ユーザー管理者
        ...
        public void Case07()
        {
            ...
            Assert.Equal(user.UserGroupEndUsers.First().UserGroup.Name, json["userGroups"]?[0]?["name"].ToString());
