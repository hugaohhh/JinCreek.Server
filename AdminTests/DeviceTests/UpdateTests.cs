...
namespace JinCreek.Server.AdminTests.DeviceTests
{
    ...
    public class UpdateTests : IClassFixture<CustomWebApplicationFactoryWithMariaDb<Admin.Startup>>
    {
        ...
        public UpdateTests(CustomWebApplicationFactoryWithMariaDb<Admin.Startup> factory)
        {
            ...
            _context.Add(_device1 = new Device { OrganizationClientApp = _organizationClientApp1, Name = "device1", ManagedNumber = "1", Domain = _domain1, DeviceGroupDevices = new HashSet<DeviceGroupDevice> { new DeviceGroupDevice { DeviceGroup = _deviceGroup1 } }, WindowsSignInListCacheDays = 0 });
            _context.Add(_device1B = new Device { OrganizationClientApp = _organizationClientApp1, Name = "device1b", ManagedNumber = "2", Domain = _domain1, DeviceGroupDevices = new HashSet<DeviceGroupDevice> { new DeviceGroupDevice { DeviceGroup = _deviceGroup1 } }, WindowsSignInListCacheDays = 0 });
            _context.Add(_device2 = new Device { OrganizationClientApp = _organizationClientApp1, Name = "device2", ManagedNumber = "1", Domain = _domain2, DeviceGroupDevices = new HashSet<DeviceGroupDevice> { new DeviceGroupDevice { DeviceGroup = _deviceGroup2 } }, WindowsSignInListCacheDays = 0 });
        ...
        ///// <summary>
        ///// 社内管理番号が組織内でユニークにならないパターン
        ///// </summary>
        //[Fact]
        //[SuppressMessage("ReSharper", "RedundantAnonymousProductNamePropertyName")]
        //public void Case07()
        //{
        //    var token = Utils.GetAccessToken(_client, "user0", "user0"); // スーパー管理者
        //    var obj = new
        ...
        public void Case10()
        {
            ...
            var (response, _, json) = Utils.Put(_client, $"{Url}/{_device1.Id}", Utils.CreateJsonContent(obj), "user0", "user0"); // スーパー管理者
