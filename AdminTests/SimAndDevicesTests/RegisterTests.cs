...
namespace JinCreek.Server.AdminTests.SimAndDevicesTests
{
    ...
    public class RegisterTests : IClassFixture<CustomWebApplicationFactory<JinCreek.Server.Admin.Startup>>
    {
        ...
        public RegisterTests(CustomWebApplicationFactory<JinCreek.Server.Admin.Startup> factory)
        {
        ...
        {
            var obj = new { };
            var (response,body,_) = Utils.Post(_client, $"{Url}/", Utils.CreateJsonContent(obj), "user1", "user1", 1, "domain01"); // ユーザー管理者
            // Assert
