...
namespace JinCreek.Server.AdminTests.SimTests
{
    ...
    public class CsvImportTests : IClassFixture<CustomWebApplicationFactoryWithMariaDb<JinCreek.Server.Admin.Startup>>
    {
        ...
        public void Case01()
        {
            ...
            obj.AppendLine($",{sim1.Id},{_simGroup1.Id},{_simGroup1.Name},{sim1.Msisdn},{sim1.Imsi},{sim1.IccId},sim001,123456");
        ...
        public void Case22()
        {
            ...
            Assert.Equal(sim1.SimGroup.NasIp, list[0]["simGroup"]?["nasIp"].ToString());
