...
namespace JinCreek.Server.AdminTests.SimAndDevicesTests
{
    ...
    public class CsvImportTests : IClassFixture<CustomWebApplicationFactoryWithMariaDb<JinCreek.Server.Admin.Startup>>
    {
        ...
        private const string Url = "/api/sim-and-devices/csv";
        ...
        public void Case01()
        {
            ...
            obj.AppendLine($",{simDevice.SimId},{simDevice.Sim.Msisdn},{simDevice.Device.Domain.Name},{simDevice.DeviceId},{simDevice.Device.Name},127.0.0.1/20,1,2020-02-01,2020-03-01");
        ...
        public void Case19()
        {
            ...
            _context.AddRange(simDevice, simDevice2, simDevice3);
            _context.SaveChanges();

            var obj = new StringBuilder();
            obj.AppendLine("is Delete,SIM ID,MSISDN,Domain,Device ID,Device Name,Isolated NW2 IP,Authentication Duration,Start Date,End Date");
            obj.AppendLine($",{simDevice.SimId},{simDevice.Sim.Msisdn},{simDevice.Device.Domain.Name},{simDevice.DeviceId},{simDevice.Device.Name},127.0.0.1/20,1,2020-02-01,2020-03-01");//更新データ
            ...
            obj.AppendLine($"D,{simDevice3.SimId},{simDevice3.Sim.Msisdn},{simDevice3.Device.Domain.Name},{simDevice3.DeviceId},{simDevice3.Device.Name},127.0.0.1/20,1,2020-02-01,2020-03-01");//削除データ
            obj.AppendLine($",{_sim1.Id},{_sim1.Msisdn},{_device2.Domain.Name},{_device2.Id},{_device2.Name},127.0.0.1/20,0,2020-02-01,2020-03-01");//登録データ
            ...
            //更新データチェック
            Assert.Equal(simDevice.Id, list[0]["id"]);
            Assert.Equal(simDevice.SimId, list[0]["simId"]);
            Assert.Equal(simDevice.DeviceId, list[0]["deviceId"]);
            ...
            Assert.Equal(simDevice2.Id, list[1]["id"]);
            Assert.Equal(simDevice2.SimId, list[1]["simId"]);
            Assert.Equal(simDevice2.DeviceId, list[1]["deviceId"]);
            Assert.Equal("127.0.0.1/20", list[1]["isolatedNw2Ip"].ToString());
            Assert.Equal("2020-02-01", (string)list[1]["startDate"]);
            Assert.Equal("2020-03-01", (string)list[1]["endDate"]);
            Assert.Equal("1", list[1]["authenticationDuration"]);

            //削除データチェック
            Assert.Empty(_context.SimAndDevice.Where(s => s.Id == Guid.Parse(list[2]["id"].ToString())));
        ...
        public void Case20()
        {
            ...
            obj.AppendLine("is Delete,SIM ID,MSISDN,Domain,Device ID,Device Name,Isolated NW2 IP,Authentication Duration,Start Date,End Date");
            obj.AppendLine($",{simDevice.SimId},{simDevice.Sim.Msisdn},{simDevice.Device.Domain.Name},{simDevice.DeviceId},{simDevice.Device.Name},127.0.0.1/20,1,2020-02-01,2020-03-01");//更新データ
            obj.AppendLine($",{simDevice2.SimId},{simDevice2.Sim.Msisdn},{simDevice2.Device.Domain.Name},{simDevice2.DeviceId},{simDevice2.Device.Name},127.0.0.1/20,1,2020-01-01,2020-03-01");//更新データ
        ...
        public void Case21()
        {
            ...
            obj.AppendLine("is Delete,SIM ID,MSISDN,Domain,Device ID,Device Name,Isolated NW2 IP,Authentication Duration,Start Date,End Date");
            obj.AppendLine($",{simDevice.SimId},{simDevice.Sim.Msisdn},{simDevice.Device.Domain.Name},{simDevice.DeviceId},{simDevice.Device.Name},127.0.0.1/20,1,2020-02-01,2020-03-01");//更新データ
            obj.AppendLine($",{simDevice2.SimId},{simDevice2.Sim.Msisdn},{simDevice2.Device.Domain.Name},{simDevice2.DeviceId},{simDevice2.Device.Name},127.0.0.1/20,1,2021-02-02,2021-02-03");//更新データ
        ...
        public void Case22()
        {
            ...
            obj.AppendLine("is Delete,SIM ID,MSISDN,Domain,Device ID,Device Name,Isolated NW2 IP,Authentication Duration,Start Date,End Date");
            obj.AppendLine($",{simDevice.SimId},{simDevice.Sim.Msisdn},{simDevice.Device.Domain.Name},{simDevice.DeviceId},{simDevice.Device.Name},127.0.0.1/20,1,2020-02-01,2020-03-01");//更新データ
            obj.AppendLine($",{simDevice2.SimId},{simDevice2.Sim.Msisdn},{simDevice2.Device.Domain.Name},{simDevice2.DeviceId},{simDevice2.Device.Name},127.0.0.1/20,1,2020-01-28,2020-01-29");//更新データ
        ...
        public void Case23()
        {
            ...
            obj.AppendLine("is Delete,SIM ID,MSISDN,Domain,Device ID,Device Name,Isolated NW2 IP,Authentication Duration,Start Date,End Date");
            obj.AppendLine($",{simDevice.SimId},{simDevice.Sim.Msisdn},{simDevice.Device.Domain.Name},{simDevice.DeviceId},{simDevice.Device.Name},127.0.0.1/20,1,2020-02-01,2020-03-01");//更新データ
            obj.AppendLine($",{simDevice2.SimId},{simDevice2.Sim.Msisdn},{simDevice2.Device.Domain.Name},{simDevice2.DeviceId},{simDevice2.Device.Name},127.0.0.1/20,1,2020-02-01,2021-03-01");//更新データ
