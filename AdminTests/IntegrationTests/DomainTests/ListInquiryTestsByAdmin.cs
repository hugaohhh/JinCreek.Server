...
namespace AdminTests.IntegrationTests.DomainTests
{
    ...
    public class ListInquiryTestsByAdmin : IClassFixture<CustomWebApplicationFactory<Admin.Startup>>
    {
        private readonly HttpClient _client;
        private const string Url = "/api/domains";

        public ListInquiryTestsByAdmin(CustomWebApplicationFactory<Admin.Startup> factory)
        {
        ...
        /// <summary>
        /// ページ数が中間ページ・1ページ当たり表示件数なし・ドメイン名の昇順でソート
        /// </summary>
        [Fact]
        public void Case07()
        {
        ...
        /// <summary>
        /// ページ数が最終ページ・1ページ当たり表示件数あり・ドメイン名の降順でソート
        /// </summary>
        [Fact]
        public void Case08()
        {
